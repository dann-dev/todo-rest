...
public class ItemService {
	...
	@POST
	public String postItem(@FormParam("id") String id, @FormParam("name") String name, @FormParam("desc") String desc, @FormParam("listid") String listId) throws NoMatchingListException {
